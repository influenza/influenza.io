...
import axios from "axios";
  ...
  let navigate=useNavigate()
        ...
        let dataar = Cookies.get().dataar.split(",")
        
        function moveArray(e){
            console.log(e)
            if(e >= 4){
                if(!(e+2 == arraypages.length)){
                    dataar.push(e+2)
                }
              
            }else{
             dataar =[1,2,3,4,5,arraypages.length]
            }
            console.log(dataar)

            console.log(Cookies.get().dataar.split(","))
            Cookies.set("dataar",dataar)
        }
...
if(url*100>=index && url*100-100<=index){
