        ...
        export default function  Banimento(props){
            ...
            return(
                <div style={{display:"flex", flexDirection:"row"}}>
                    <div style={{backgroundColor:"white",marginRight:"200px", width:"18vw", display:"grid",height:"100vh",position:"fixed",overflow:"hidden"}}>
                    <div style={{fontSize:"30px",marginLeft:"10px", display:"flex", flexDirection:"row",alignItems:"center",marginRight:"10px"}}>
                            Equipe:{Cookies.get().NomeEqui}
                        </div>
                        <div style={{fontSize:"30px",marginLeft:"10px", display:"flex", flexDirection:"row",alignItems:"center",marginRight:"10px"}}>
        ...
        -72z"/>
                    ...
                    <div style={{ display:"flex",flexDirection:"column", width:"86vw"}}>
                        ...
                        <Button type="button" text ="Redefinir dados" func={(()=>{
                            ...
                            <div style={{ width:"86vw", display:"flex",flexDirection:"row", justifyContent:"space-around", textAlign:"center"}}>
                            <div>
                            <div style={{marginLeft:"20px",backgroundImage:`url(${imageperfil})`, backgroundSize:"cover", backgroundPositionX:"center", backgroundPositionY:"center", backgroundColor:"#14B57A", width:"350px", height:"350px", borderRadius: "50%",justifyContent:"space-around", display:"flex"}}>
                                <div></div>
                                <div></div>
                                <div></div>
        ...
        <g>
            ...
            <g>
                      ...
                      <InputPer type={text} text={`Gabriel`}></InputPer>
                        ...
                        <div style={{ marginBottom:"100px",width:"86vw", display:"flex",flexDirection:"row", justifyContent:"space-around", textAlign:"left",marginTop:"60px"}}>
                        <div style={{display:"flex", flexDirection:"column"}}>
                      ...
                      <InputPer type={text} text={`${Cookies.get().Area}`}></InputPer>
                        ...
                        <div style={{display:"flex",marginTop:"30px",flexDirection:"row",justifyContent:"space-around",marginBottom:"0px"}}>
                        <div style={{display:"flex",fontSize:"30px", flexDirection:"column"}}>
