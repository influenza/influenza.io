...
import "./404.css"
export function HomeEqui(props){
...
function handlePular(e){
    ...
    return(
        <div style={{display:"flex", flexDirection:"row"}}>
                  <div style={{backgroundColor:"#f5ebe0", width:"100vw", height:"100vh", justifyContent:"center", textAlign:"center"}}>
                  <Navbar2 es={0}></Navbar2>
         <div style={{marginLeft:"8vw",width:"82vw",display:"flex",justifyContent:"center", flexDirection:"column", alignItems:"center", height:"100vh"}}>
           
              
           
                
                
                    <div style={{justifyContent:"space-between",width:"65vw",alignItems:"center",display:"flex", flexDirection:"row"}}>
              ...
              <InputPer type={text} text={Cookies.get().Nome}></InputPer>
                ...
                <div style={{ marginTop:"50px", borderTop: "2px solid black ",  width:"102vw" }}></div>
